...
class getOrganizationStructure implements Tool
{
    ...
    {
        return 'Get the academy structure: every stage (برنامج) with its supervisors, and every circle (دفعة) within it with its teachers and student counts by status. '
