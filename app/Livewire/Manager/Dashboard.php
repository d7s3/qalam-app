...
class Dashboard extends Component
{
    ...
    public function getAttendanceDataProperty(): array
    {
        ...
        $circleStudentCounts = Scope::forRole('manager')
            ->applyToStudents(Student::whereNotNull('circle_id'))
    ...
    {
        return Scope::forRole('manager')->applyToStages(Stage::with('circles'))
            ->get()->map(function ($stage) use ($from, $to) {
