...
new class extends Component
{
    ...
    public function generateInsights()
    {
        ...
        $prompt = "قم بتحليل بيانات الحضور والانصراف التالية لشهر {$this->period} واستخرج الأنماط. ابحث عن الأشياء المميزة مثل: الطلاب الأكثر التزامًا، الدفعات الأفضل أو الأسوأ أداءً، والطلاب الذين يتأخرون كثيرًا. \n\n"
            . "يجب أن يكون الرد عبارة عن مصفوفة JSON صالحة تفقط دون أي نص إضافي ، كل عنصر يحتوي على:\n"
            . "- category: (مثل: 'الطلاب', 'الدفعات')\n"
