...
Route::middleware(['auth:supervisor', 'approved'])->prefix('supervisor')->name('supervisor.')->group(function () {
    ...
    Route::view('/hadiths/plans', 'supervisor.hadith-plans')->name('hadiths.plans');
...
Route::middleware(['auth:teacher', 'approved'])->prefix('teacher')->name('teacher.')->group(function () {
    ...
    Route::view('/hadith-plan-creator', 'teacher.hadith-plan-creator')->name('hadith-plan-creator');
    Route::view('/hadith-plans', 'teacher.hadith-plans')->name('hadith-plans');
